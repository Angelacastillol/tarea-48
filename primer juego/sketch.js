...
function draw() {
  ...
  trex1.setCollider("circle",0,0,30);
  trex1.debug=true;

  trex2.setCollider("circle",0,0,30);
  trex2.debug=true;
...
function nubes(){
  ...
  if(frameCount%85==0){
    ...
    cloud= createSprite(windowWidth,130,10,10)
    ...
    cloud2.y=Math.round(random(300,440));
    console.log(cloud);
